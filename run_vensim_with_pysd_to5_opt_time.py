    ...
    if _MODEL is None:
        if MODEL_MDL.exists():
            ...
            raise FileNotFoundError(
                "River_management_xls_to5.mdl が見つかりません。"
            )
    return _MODEL
...
USE_LEAP_YEARS = True  # River_management_xls_to5.py と合わせる
...
if __name__ == "__main__":
    ...
    # ---- CSV出力 ----
    output_path = Path("data/opt_result_to5_time_all.csv")
    ...
    for indicator in OUTPUT_INDICATORS:
        ...
        indicator_path = Path(f"data/opt_result_to5_time_{indicator}.csv")
